namespace Bol5_Ejer5._1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.button1, "Add items to main list");
            ...
            this.toolTip1.SetToolTip(this.button2, "Remove selected item from main list");
            ...
            this.button3.Text = "Transfer to 2";
            this.toolTip1.SetToolTip(this.button3, "Transfer selected items from the main list to the second list");
            ...
            this.button4.Text = "Transfer to 1";
            this.toolTip1.SetToolTip(this.button4, "Transfer selected item from the second list to the main list");
